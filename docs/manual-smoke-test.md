...
The remaining representative actual gate is native Korean IME. Independent review of this new code correction and final evidence is still pending; the previous code approval applies to the earlier candidate. Keep PR #103 Draft until those requirements are resolved. No merge or release was performed.
